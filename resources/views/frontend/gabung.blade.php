        ...
        <form action="{{ route('join.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="phone_number" id="phone_number" value="{{ old('phone_number') }}"
                       class="w-full rounded-md border-gray-300 shadow-sm border px-4 py-3 focus:border-red-500 focus:ring-red-500 @error('phone_number') border-red-500 @enderror"
            ...
            <div>
                ...
                <textarea name="reason" id="reason" rows="4" required
                          class="w-full rounded-md border-gray-300 shadow-sm border px-4 py-3 focus:border-red-500 focus:ring-red-500 @error('reason') border-red-500 @enderror"
