...
@section('page_title', 'Tambah Akun Pengguna / Admin Baru')
...
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Buat akun baru untuk admin atau pengguna aplikasi.</p>
        </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
            ...
            <div>
                ...
                <select name="role" id="role" required
                    ...
                    <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>Admin (Akses Penuh Panel Admin)</option>
