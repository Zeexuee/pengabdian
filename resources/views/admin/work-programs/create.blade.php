...
<div class="mb-6 flex justify-between items-center">
    <a href="{{ route('admin.work-programs.index') }}" class="text-red-600 hover:underline">&larr; Kembali ke Daftar</a>
</div>
...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <form action="{{ route('admin.work-programs.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <select name="status" id="status" required class="w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500 sm:text-sm">
