...
<form action="{{ route('admin.home-sections.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 max-w-4xl">
    ...
    <div class="bg-white p-6 border rounded-lg shadow-sm">
        ...
        <div class="mb-6">
            ...
            <select name="type" id="type_selector" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500 p-2 border" required>
        ...
        <div class="space-y-6">
            ...
            <div class="field-group" data-show-for="video">
                ...
                <input type="url" name="video_url" value="{{ old('video_url') }}" placeholder="https://www.youtube.com/watch?v=..." class="w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500 p-2 border">
        ...
        <div class="mb-6">
            <label class="flex items-center">
                <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-red-600 shadow-sm focus:ring-red-500" {{ old('is_active', true) ? 'checked' : '' }}>
