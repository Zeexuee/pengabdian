...
<form action="{{ route('admin.home-sections.update', $homeSection->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6 max-w-4xl">
    ...
    <div class="bg-white p-6 border rounded-lg shadow-sm">
        ...
        <div class="mb-6">
            ...
            <select name="type" id="type_selector" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border bg-gray-100" required>
        ...
        <div class="space-y-6">
            ...
            <div class="field-group" data-show-for="text,image_text,video">
                ...
                <input type="text" name="title" value="{{ old('title', $homeSection->title) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border">
            ...
            <div class="field-group" data-show-for="video">
                ...
                <input type="url" name="video_url" value="{{ old('video_url', $homeSection->video_url) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border">
            ...
            <div class="field-group" data-show-for="text,image_text">
                ...
                <textarea name="content" id="content_editor" rows="5" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border">{{ old('content', $homeSection->content) }}</textarea>
            ...
            <div class="field-group grid grid-cols-2 gap-4" data-show-for="image_text">
                <div>
                    ...
                    <input type="text" name="button_text" value="{{ old('button_text', $homeSection->button_text) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Link Tombol (Opsional)</label>
                    <input type="text" name="button_link" value="{{ old('button_link', $homeSection->button_link) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border">
                </div>
            </div>
        ...
        <div class="mb-6">
            <label class="flex items-center">
                <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500" {{ old('is_active', $homeSection->is_active) ? 'checked' : '' }}>
